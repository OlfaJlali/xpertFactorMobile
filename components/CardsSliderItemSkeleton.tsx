...
const CardsSliderItemSkeleton = (props: any) => (
  <Svg
    width={width * 0.9}
    height={height / 4}
    viewBox="0 0 249 157"
    ...
    {...props}
  >
    {/* Background Path with grey color for skeleton */}
    <Path
      ...
      fill="#D3D3D3" // Grey background for skeleton
    />
    <Mask
      id="b"
      style={{
    ...
    >
      ...
      <Path
        ...
        fill="#B0B0B0" // Grey for skeleton
      />
    </Mask>
    <G mask="url(#b)">
      {/* Grey Paths for skeleton */}
      <Path
        opacity={0.8}
...
export default CardsSliderItemSkeleton;
